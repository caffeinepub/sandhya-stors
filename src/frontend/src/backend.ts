...
export class Backend implements backendInterface {
    ...
    async generateShortUrl(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateShortUrl(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async processRedirect(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.processRedirect(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
